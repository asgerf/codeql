...
module Unified {
  ...
  class CompoundAssignExpr extends @unified_compound_assign_expr, AstNode {
    ...
    /** Gets the node corresponding to the field `operator`. */
    final Operator getOperator() { unified_compound_assign_expr_def(this, result, _, _) }
  ...
  /** A class representing `computed_property_accessor` nodes. */
  class ComputedPropertyAccessor extends @unified_computed_property_accessor, AstNode {
    /** Gets the name of the primary QL class for this element. */
    final override string getAPrimaryQlClass() { result = "ComputedPropertyAccessor" }

    /** Gets the node corresponding to the field `accessor_kind`. */
    final AccessorKind getAccessorKind() { unified_computed_property_accessor_def(this, result) }

    /** Gets the node corresponding to the field `body`. */
    final Block getBody() { unified_computed_property_accessor_body(this, result) }

    /** Gets the node corresponding to the field `modifier`. */
    final Modifier getModifier(int i) {
      unified_computed_property_accessor_modifier(this, i, result)
    }

    /** Gets the node corresponding to the field `parameter`. */
    final Parameter getParameter(int i) {
      unified_computed_property_accessor_parameter(this, i, result)
    }

    /** Gets the node corresponding to the field `return_type`. */
    final TypeExpr getReturnType() { unified_computed_property_accessor_return_type(this, result) }

    /** Gets a field or child node of this node. */
    final override AstNode getAFieldOrChild() {
      unified_computed_property_accessor_def(this, result) or
      unified_computed_property_accessor_body(this, result) or
      unified_computed_property_accessor_modifier(this, _, result) or
      unified_computed_property_accessor_parameter(this, _, result) or
      unified_computed_property_accessor_return_type(this, result)
    }
  }

  /** A class representing `computed_property_declaration` nodes. */
  class ComputedPropertyDeclaration extends @unified_computed_property_declaration, AstNode {
    /** Gets the name of the primary QL class for this element. */
    final override string getAPrimaryQlClass() { result = "ComputedPropertyDeclaration" }

    /** Gets the node corresponding to the field `accessors`. */
    final ComputedPropertyAccessor getAccessors(int i) {
      unified_computed_property_declaration_accessors(this, i, result)
    }

    /** Gets the node corresponding to the field `initializer`. */
    final Expr getInitializer() { unified_computed_property_declaration_initializer(this, result) }

    /** Gets the node corresponding to the field `modifier`. */
    final Modifier getModifier(int i) {
      unified_computed_property_declaration_modifier(this, i, result)
    }

    /** Gets the node corresponding to the field `name`. */
    final Identifier getName() { unified_computed_property_declaration_def(this, result) }

    /** Gets the node corresponding to the field `type`. */
    final TypeExpr getType() { unified_computed_property_declaration_type(this, result) }

    /** Gets a field or child node of this node. */
    final override AstNode getAFieldOrChild() {
      unified_computed_property_declaration_accessors(this, _, result) or
      unified_computed_property_declaration_initializer(this, result) or
      unified_computed_property_declaration_modifier(this, _, result) or
      unified_computed_property_declaration_def(this, result) or
      unified_computed_property_declaration_type(this, result)
    }
  }
  ...
  class FunctionExpr extends @unified_function_expr, AstNode {
    ...
    final override AstNode getAFieldOrChild() {
      ...
      unified_function_expr_parameter(this, _, result)
    }
  }
  ...
  class TypeCastExpr extends @unified_type_cast_expr, AstNode {
    ...
    /** Gets the node corresponding to the field `operator`. */
    final Operator getOperator() { unified_type_cast_expr_def(this, _, result, _) }
  ...
  class TypeTestExpr extends @unified_type_test_expr, AstNode {
    ...
    /** Gets the node corresponding to the field `operator`. */
    final Operator getOperator() { unified_type_test_expr_def(this, _, result, _) }

  ...
  override predicate row(string row) {
    row =
      [
        ...
        "pg-promise/pg-subset;pg.IClient;pg-promise;;ReturnValue.TypeVar[pg-promise.IMain.1]", //
        ...
        "pg;Client;pg-pool;Static;Argument[0].TypeVar[pg-pool.Config.0]", //
        "pg;Client;pg-pool;Static;Argument[1].TypeVar[pg-pool.ClientLikeCtr.0]", //
  ...
  override predicate row(string row) {
    row =
      [
        ...
        "pg-pool.Config.0;Member[Client].TypeVar[pg-pool.ClientLikeCtr.0]", //

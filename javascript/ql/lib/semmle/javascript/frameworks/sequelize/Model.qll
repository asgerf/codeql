...
private class Types extends ModelInput::TypeModelCsv {
  override predicate row(string row) {
    row =
      [
        "sequelize-typescript/dist/associations/belongs-to-many/belongs-to-many-association;BelongsToManyAssociationStatic;sequelize-typescript/dist/associations/belongs-to-many/belongs-to-many-association;;Member[BelongsToManyAssociation]", //
        ...
        "sequelize-typescript/dist/associations/belongs-to/belongs-to-association;BelongsToAssociationStatic;sequelize-typescript/dist/associations/belongs-to/belongs-to-association;;Member[BelongsToAssociation]", //
        ...
        "sequelize-typescript/dist/associations/foreign-key/foreign-key-meta;ForeignKeyMeta;sequelize-typescript/dist/associations/foreign-key/foreign-key-service;;Member[getForeignKeys].ReturnValue.ArrayElement", //
        "sequelize-typescript/dist/associations/has/has-association;HasAssociationStatic;sequelize-typescript/dist/associations/has/has-association;;Member[HasAssociation]", //
        ...
        "sequelize-typescript/dist/associations/shared/base-association;;sequelize-typescript/dist/associations/shared/base-association;;", //
        "sequelize-typescript/dist/associations/shared/base-association;BaseAssociationStatic;sequelize-typescript/dist/associations/shared/base-association;;Member[BaseAssociation]", //
        ...
        "sequelize-typescript/dist/model/model/model;;sequelize-typescript/dist/model/model/model;;", //
        "sequelize-typescript/dist/model/model/model;ModelStatic~;sequelize-typescript/dist/model/model/model;;Member[Model]", //
        ...
        "sequelize-typescript/dist/model/shared/model-not-initialized-error;ModelNotInitializedErrorStatic;sequelize-typescript/dist/model/shared/model-not-initialized-error;;Member[ModelNotInitializedError]", //
        "sequelize-typescript/dist/sequelize/sequelize/sequelize;;sequelize-typescript/dist/sequelize/sequelize/sequelize;;", //
        "sequelize-typescript/dist/sequelize/sequelize/sequelize;SequelizeStatic;sequelize-typescript/dist/sequelize/sequelize/sequelize;;Member[Sequelize]", //
        "sequelize-typescript/dist/sequelize/sequelize/sequelize;SequelizeStatic;sequelize-typescript;;Member[Sequelize]", //
        "sequelize-typescript;;sequelize-typescript/dist;;", //
        ...
        "sequelize-typescript;BaseAssociation;sequelize-typescript/dist/associations/shared/association-service;;Member[addAssociation].Argument[1]", //
        "sequelize-typescript;BaseAssociation;sequelize-typescript/dist/associations/shared/association-service;;Member[getAssociations,getAssociationsByRelation].ReturnValue.ArrayElement", //
        "sequelize-typescript;BaseAssociation;sequelize-typescript/dist/associations/shared/association-service;;Member[setAssociations].Argument[1].ArrayElement", //
        ...
        "sequelize-typescript;DefaultScopeGetter;sequelize-typescript/dist/scopes/default-scope;;Member[DefaultScope].Argument[0]", //
        ...
        "sequelize-typescript;ModelClassGetter;sequelize-typescript/dist/associations/belongs-to-many/belongs-to-many;;Member[BelongsToMany].Argument[0,1]", //
        ...
        "sequelize-typescript;ModelClassGetter;sequelize-typescript/dist/associations/belongs-to/belongs-to;;Member[BelongsTo].Argument[0]", //
        ...
        "sequelize-typescript;ModelClassGetter;sequelize-typescript/dist/associations/foreign-key/foreign-key-service;;Member[addForeignKey].Argument[1]", //
        "sequelize-typescript;ModelClassGetter;sequelize-typescript/dist/associations/foreign-key/foreign-key;;Member[ForeignKey].Argument[0]", //
        ...
        "sequelize-typescript;ModelClassGetter;sequelize-typescript/dist/associations/has/has-many;;Member[HasMany].Argument[0]", //
        "sequelize-typescript;ModelClassGetter;sequelize-typescript/dist/associations/has/has-one;;Member[HasOne].Argument[0]", //
        ...
        "sequelize-typescript;ModelCtor;sequelize-typescript/dist/hooks/shared/hooks-service;;Member[installHooks].Argument[0].ArrayElement", //
        "sequelize-typescript;ModelCtor;sequelize-typescript/dist/model/model/model;ModelCtor;", //
        "sequelize-typescript;ModelCtor;sequelize-typescript/dist/scopes/scope-service;;Member[resolveScope].Argument[1]", //
        "sequelize-typescript;ModelCtor;sequelize-typescript/dist/scopes/scope-service;;Member[resolveScopes].Argument[0].ArrayElement", //
        "sequelize-typescript;ModelCtor;sequelize-typescript/dist/scopes/scope-service;;Member[resolvesDeprecatedScopes].Argument[0]", //
        "sequelize-typescript;ModelCtor;sequelize-typescript/dist/sequelize/sequelize/sequelize-service;;Member[getModels].Argument[0].ArrayElement", //
        "sequelize-typescript;ModelCtor;sequelize-typescript/dist/sequelize/sequelize/sequelize-service;;Member[getModels].ReturnValue.ArrayElement", //
        ...
        "sequelize-typescript;ModelType;sequelize-typescript/dist/associations/foreign-key/foreign-key-service;;Member[getForeignKeyOptions].Argument[0,1]", //
        ...
        "sequelize-typescript;ScopeOptionsGetters;sequelize-typescript/dist/scopes/scope-service;;Member[addScopeOptionsGetter,setScopeOptionsGetters].Argument[1]", //
        "sequelize-typescript;ScopeOptionsGetters;sequelize-typescript/dist/scopes/scope-service;;Member[getScopeOptionsGetters].ReturnValue", //
        ...
        "sequelize-typescript;ScopesOptions;sequelize-typescript/dist/scopes/scope-service;;Member[resolveScope].Argument[2]", //
        ...
        "sequelize-typescript;SequelizeOptions;sequelize-typescript/dist/sequelize/sequelize/sequelize-service;;Member[prepareArgs].ReturnValue.Member[options]", //
        "sequelize-typescript;SequelizeOptions;sequelize-typescript/dist/sequelize/sequelize/sequelize-service;;Member[prepareOptions].Argument[0]", //
        "sequelize-typescript;SequelizeOptions;sequelize-typescript/dist/sequelize/sequelize/sequelize-service;;Member[prepareOptions].ReturnValue", //

  ...
  override predicate row(string row) {
    row =
      [
        ...
        "mongoose;Document;mongoose;;Member[model].Argument[1].TypeVar[mongoose.Schema.0]", //
        ...
        "mongoose;Schema;mongoose;Schema;Member[discriminator].ReturnValue.TypeVar[mongoose.DiscriminatorSchema.5]", //

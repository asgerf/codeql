  ...
  override predicate row(string row) {
    row =
      [
        ...
        "mysql2;Connection;mysql2;Connection;Member[addListener,on,once,prependListener,prependOnceListener].ReturnValue", //
        ...
        "mysql2;PoolConnection;mysql2;PoolConnection;Member[addListener,on,once,prependListener,prependOnceListener].ReturnValue", //
